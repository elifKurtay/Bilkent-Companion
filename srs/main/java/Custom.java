...
public class Custom extends ArrayAdapter<String> {
    ...
    private String[] itemNames, desc, prices, keys, uids, uploader_names, picture;
    private Activity context;
    private StorageReference storageReference;
    private Uri uri;
    private String url;

    public Custom(Activity context, ArrayList<String> itemNames, ArrayList<String> desc, ArrayList<String> prices, ArrayList<String> uids , ArrayList<String> uploaderNames, ArrayList<String> picture) {
